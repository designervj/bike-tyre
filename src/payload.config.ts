...
import { ProductVariants } from "./collections/Productvariant";
import { ShopConfiguration } from "./globals/Ecommerce/config";
...
export default buildConfig({
  ...
  // Explicitly override the admin description used for social/link previews.
  // Setting a single space ensures the value is present (truthy) and will
  // override Payload's default description while keeping the tag empty.
  description: " ",
    },
    importMap: {
